...
export default function ViewSegmentPage() {
    ...
    if (loading) return <div className="p-8 text-center">Cargando visualización...</div>;
    ...
    return (
        <div>
            <div className="p-4 bg-gray-50 border-b flex items-center justify-between">
                 ...
                 <span className="text-sm font-bold text-gray-500">Modo Visualización: ID {id}</span>
            </div>
            <Segmento mode="view" initialData={initialData} />
        </div>
    );
}
